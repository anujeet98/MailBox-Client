...
function SideNav() {
  ...
  return (
    <Navbar className="p-0 m-0 bg-secondary-subtle mh-100 fs-5 d-flex flex-column pt-5" style={{width: '20rem'}}>
            ...
            <Nav className="d-flex flex-column align-items-start mt-3 ">
                <NavLink to={"/home/compose"} className='text-decoration-none link-dark '>Compose<span>{unreadCount} Unread</span></NavLink>
